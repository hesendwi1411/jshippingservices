            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://gentasolsui.com" target="_blank">IT Dept</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="http://gentasolsui.com" target="_blank">IT dept</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->

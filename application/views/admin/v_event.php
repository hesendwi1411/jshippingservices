                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo base_url().'admin/schedule'?>">Type</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/events'?>"><i class="si si-calendar"></i><span class="sidebar-mini-hide">Jobs</span></a>
                                </li>
                                <li>
                                    ...
                                    <table id="mytable" class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->event_customer;?></td>
                                                <td><?php echo $row->event_jenis;?></td>
                                                <td><?php echo $row->event_lokasi;?></td>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://gentasolusi.com" target="_blank">IT Dept</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="form-group">
                                <input type="text" name="xnama" class="form-control" placeholder="Job Name" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xjadwal" class="form-control" placeholder="Job Schedule" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xcustomer" class="form-control" placeholder="Job Customer" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xlokasi" class="form-control" placeholder="Job Location" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xjenis" class="form-control" placeholder="Type Fleets" required>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Update Jobs</h3>
                            <div class="block-options">
                                <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                    <i class="si si-close"></i>
                                </button>
                        ...
                        <div class="block-content">
                             <div class="form-group">
                                <input type="text" name="xnama2" class="form-control" placeholder="Job Name" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xjadwal2" class="form-control" placeholder="Job Schedule" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xcustomer2" class="form-control" placeholder="Job Customer" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xlokasi2" class="form-control" placeholder="Job Locations" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xjenis2" class="form-control" placeholder="Type Fleets" required>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus jobs ini?</p>
            ...
            $(document).ready(function() {
                ...
                $('.btn-edit').on('click',function(){
                    ...
                    $('[name="xjadwal2"]').val(jadwal);
                     $('[name="xcustomer2"]').val(customer);
                    $('[name="xlokasi2"]').val(lokasi);
                    $('[name="xjenis2"]').val(jenis);
                });

                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/room'?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Services</span></a>
                                </li>
                                <li>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus services ini?</p>

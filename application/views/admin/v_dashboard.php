                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">J</span><span class="font-size-xl text-success"><strong>SS</strong></span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                            ...
                            <div class="block">
                                <div class="block-content block-content-full">
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-h4 font-w600"><?php echo $room_query;?> Services</div>
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                <div class="block-content block-content-full">
                                    <div class="py-20 text-center">
                                        <div class="mb-20">
                                            <i class="fa fa-ship fa-4x text-info"></i>
                                        </div>
                                        <div class="font-size-h4 font-w600"><?php echo $makan_query;?> Fleets</div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://gentasolusi.com" target="_blank">IT Dept</a>
                    </div>

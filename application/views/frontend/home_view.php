                        ...
                        <div class="col-lg-9">
                            <div class="availability-form">
                                <div class="vailability-submit">
                                    <a href="<?php echo site_url('rooms');?>" class="awe-btn awe-btn-13">BOOK A SERVICES</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="room-detail_compare">
                    ...
                    <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2 class="shortcode-heading">Our Services</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <h3 class="shortcode-heading"></h3>
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2 class="shortcode-heading">Jasmanindo Shipping Services</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/deals-1.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Shipping</a>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/deals-2.jpg'?>" alt="">
                            </div>
                            <div class="info">
                                <a class="title bold f26 font-monserat upper" href="!#">Fleets</a>
                                <p class="sub font-monserat f12 f-600 upper mt10 mb20">package</p>
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('contact');?>">Book Now</a>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-6 col-lg-offset-3">
                        ...
                        <h2 class="shortcode-heading">NEWS & INFORMATIONS</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-md-4 col-md-pull-8">
                            <div class="sidebar">
                                ...
                                <div class="widget widget_upcoming_events">
                                    <h4 class="widget-title">Upcoming Jobs</h4>
                                    <ul>
                                        <?php 
                                        ...
                                        <li>
                                            ...
                                            <div class="text">
                                                ...
                                                <span class="date"><?php echo $i->event_customer;?></span>

            ...
            <div class="content">
                <div class="row">
                    <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2>Our Clients</h2>
                            <h4>Please select one of our client to get more information</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/reservation_pantner/rig.png'?>" alt="">
                            </div>
                            <div class="info">
                                <!-- GANTI DENGAN LINK TRAVELOKA HOTEL ANDA -->
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="https://rigtenders.co.id/id/home-rti/" target="_blank">For Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/reservation_pantner/meindo.png'?>" alt="">
                            </div>
                            <div class="info"> 
                                <!-- GANTI DENGAN LINK PEGI PEGI HOTEL ANDA -->
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="http://www.meindo.com/" target="_blank">For Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/reservation_pantner/geocean.png'?>" alt="">
                            </div>
                            <div class="info">
                                <!-- GANTI DENGAN LINK BOOKING.COM HOTEL ANDA -->
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="https://www.entrepose.com/fr/geocean/" target="_blank">For Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="item item-deal">
                            <div class="img">
                                <img class="img-full" src="<?php echo base_url().'theme/images/reservation_pantner/genta.png'?>" alt="">
                            </div>
                            <div class="info">
                                <!-- GANTI DENGAN LINK AGODA HOTEL ANDA -->
                                <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="http://www.gentasolusi.com/" target="_blank">For Details</a>
                            </div>
                        </div>
                    </div>
                </div>
